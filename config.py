...
GROQ_MODEL    = "openai/gpt-oss-20b"   # replaces deprecated llama-3.1-8b-instant
...
# ============================================================
#  RUNTIME SETTINGS  —  formerly mode-based, now fixed to
#  the values that produced a real, tested 6.4% monthly result.
# ============================================================
...
MAX_DAILY_LOSS          = 50.0
GROQ_TOKEN_BUDGET       = 7200    # matches full 8-symbol batch, paced
MAX_SYMBOLS_PER_CYCLE   = 8
GROQ_CALL_DELAY_SEC     = 10.0
ALLOW_SHORTING_MODE     = False
